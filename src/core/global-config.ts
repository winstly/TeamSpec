...
// Constants
export const GLOBAL_CONFIG_DIR_NAME = 'teamspec';
...
const DEFAULT_CONFIG: GlobalConfig = {
  ...
  profile: 'core',
  delivery: 'both',
  agencyRepoUrl: 'https://github.com/msitarzewski/agency-agents.git',
  agencyBranch: 'main',
  knowledgeBase: 'local',
};
 ...
 *
 * - All platforms: $XDG_CONFIG_HOME/teamspec/ if XDG_CONFIG_HOME is set
 * - Unix/macOS fallback: ~/.config/teamspec/
 * - Windows fallback: %APPDATA%/teamspec/
 */
 ...
 *
 * - All platforms: $XDG_DATA_HOME/teamspec/ if XDG_DATA_HOME is set
 * - Unix/macOS fallback: ~/.local/share/teamspec/
 * - Windows fallback: %LOCALAPPDATA%/teamspec/
 */
